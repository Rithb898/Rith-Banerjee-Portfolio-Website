  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center md:bg-black md:rounded-full md:py-20 md:px-28">
        ...
        <h1 className="max-w-3xl text-white tracking-widest md:tracking-normal md:bg-gradient-to-br from-white to-gray-700 bg-clip-text text-center text-4xl font-bold leading-tight text-transparent sm:text-5xl sm:leading-tight md:text-7xl md:leading-tight font-calistoga">
          Rith Banerjee
        </h1>
